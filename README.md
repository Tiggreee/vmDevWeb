...
- Backend opcional de contacto: Node.js + Express
...
- `server/data/messages.json`: almacenamiento local de mensajes (se crea automaticamente).
...
3. Sirve el frontend con un servidor estatico (por ejemplo Live Server) y configura el formulario:
	 - En `index.html`, atributo `data-api-url` del formulario:
	 - `http://localhost:8787/api/contact`

4. Comprueba salud de API:
